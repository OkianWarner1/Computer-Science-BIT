...
!function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t(jQuery)}((function(t){var e,i,n,o,s,r,l,a,h,c,f,u;function d(t,e,i){return[parseFloat(t[0])*(c.test(t[0])?e/100:1),parseFloat(t[1])*(c.test(t[1])?i/100:1)]}function p(e,i){return parseInt(t.css(e,i),10)||0}t.ui=t.ui||{},t.ui.version="1.12.1",
/*!
 ...
 */
t.extend(t.expr[":"],{data:t.expr.createPseudo?t.expr.createPseudo((function(e){return function(i){return!!t.data(i,e)}})):function(e,i,n){return!!t.data(e,n[3])}}),
/*!
 ...
 * http://jquery.org/license
 */
t.fn.extend({disableSelection:(e="onselectstart"in document.createElement("div")?"selectstart":"mousedown",function(){return this.on(e+".ui-disableSelection",(function(t){t.preventDefault()}))}),enableSelection:function(){return this.off(".ui-disableSelection")}}),t.ui.escapeSelector=(i=/([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g,function(t){return t.replace(i,"\\$1")}),
/*!
 ...
 * http://jquery.org/license
 */
t.ui.focusable=function(e,i){var n,o,s,r,l,a=e.nodeName.toLowerCase();return"area"===a?(o=(n=e.parentNode).name,!(!e.href||!o||"map"!==n.nodeName.toLowerCase())&&0<(s=t("img[usemap='#"+o+"']")).length&&s.is(":visible")):(/^(input|select|textarea|button|object)$/.test(a)?(r=!e.disabled)&&(l=t(e).closest("fieldset")[0])&&(r=!l.disabled):r="a"===a&&e.href||i,r&&t(e).is(":visible")&&function(t){for(var e=t.css("visibility");"inherit"===e;)e=(t=t.parent()).css("visibility");return"hidden"!==e}(t(e)))},t.extend(t.expr[":"],{focusable:function(e){return t.ui.focusable(e,null!=t.attr(e,"tabindex"))}}),t.fn.form=function(){return"string"==typeof this[0].form?this.closest("form"):t(this[0].form)},
/*!
 ...
 */
o=Math.max,s=Math.abs,r=/left|center|right/,l=/top|center|bottom/,a=/[\+\-]\d+(\.[\d]+)?%?/,h=/^\w+/,c=/%$/,f=t.fn.position,t.position={scrollbarWidth:function(){if(void 0!==n)return n;var e,i,o=t("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),s=o.children()[0];return t("body").append(o),e=s.offsetWidth,o.css("overflow","scroll"),e===(i=s.offsetWidth)&&(i=o[0].clientWidth),o.remove(),n=e-i},getScrollInfo:function(e){var i=e.isWindow||e.isDocument?"":e.element.css("overflow-x"),n=e.isWindow||e.isDocument?"":e.element.css("overflow-y"),o="scroll"===i||"auto"===i&&e.width<e.element[0].scrollWidth;return{width:"scroll"===n||"auto"===n&&e.height<e.element[0].scrollHeight?t.position.scrollbarWidth():0,height:o?t.position.scrollbarWidth():0}},getWithinInfo:function(e){var i=t(e||window),n=t.isWindow(i[0]),o=!!i[0]&&9===i[0].nodeType;return{element:i,isWindow:n,isDocument:o,offset:n||o?{left:0,top:0}:t(e).offset(),scrollLeft:i.scrollLeft(),scrollTop:i.scrollTop(),width:i.outerWidth(),height:i.outerHeight()}}},t.fn.position=function(e){if(!e||!e.of)return f.apply(this,arguments);e=t.extend({},e);var i,n,c,u,g,m,v=t(e.of),b=t.position.getWithinInfo(e.within),w=t.position.getScrollInfo(b),y=(e.collision||"flip").split(" "),_={};return m=function(e){var i=e[0];return 9===i.nodeType?{width:e.width(),height:e.height(),offset:{top:0,left:0}}:t.isWindow(i)?{width:e.width(),height:e.height(),offset:{top:e.scrollTop(),left:e.scrollLeft()}}:i.preventDefault?{width:0,height:0,offset:{top:i.pageY,left:i.pageX}}:{width:e.outerWidth(),height:e.outerHeight(),offset:e.offset()}}(v),v[0].preventDefault&&(e.at="left top"),n=m.width,c=m.height,u=m.offset,g=t.extend({},u),t.each(["my","at"],(function(){var t,i,n=(e[this]||"").split(" ");1===n.length&&(n=r.test(n[0])?n.concat(["center"]):l.test(n[0])?["center"].concat(n):["center","center"]),n[0]=r.test(n[0])?n[0]:"center",n[1]=l.test(n[1])?n[1]:"center",t=a.exec(n[0]),i=a.exec(n[1]),_[this]=[t?t[0]:0,i?i[0]:0],e[this]=[h.exec(n[0])[0],h.exec(n[1])[0]]})),1===y.length&&(y[1]=y[0]),"right"===e.at[0]?g.left+=n:"center"===e.at[0]&&(g.left+=n/2),"bottom"===e.at[1]?g.top+=c:"center"===e.at[1]&&(g.top+=c/2),i=d(_.at,n,c),g.left+=i[0],g.top+=i[1],this.each((function(){var r,l,a=t(this),h=a.outerWidth(),f=a.outerHeight(),m=p(this,"marginLeft"),x=p(this,"marginTop"),W=h+m+p(this,"marginRight")+w.width,C=f+x+p(this,"marginBottom")+w.height,E=t.extend({},g),H=d(_.my,a.outerWidth(),a.outerHeight());"right"===e.my[0]?E.left-=h:"center"===e.my[0]&&(E.left-=h/2),"bottom"===e.my[1]?E.top-=f:"center"===e.my[1]&&(E.top-=f/2),E.left+=H[0],E.top+=H[1],r={marginLeft:m,marginTop:x},t.each(["left","top"],(function(o,s){t.ui.position[y[o]]&&t.ui.position[y[o]][s](E,{targetWidth:n,targetHeight:c,elemWidth:h,elemHeight:f,collisionPosition:r,collisionWidth:W,collisionHeight:C,offset:[i[0]+H[0],i[1]+H[1]],my:e.my,at:e.at,within:b,elem:a})})),e.using&&(l=function(t){var i=u.left-E.left,r=i+n-h,l=u.top-E.top,d=l+c-f,p={target:{element:v,left:u.left,top:u.top,width:n,height:c},element:{element:a,left:E.left,top:E.top,width:h,height:f},horizontal:r<0?"left":0<i?"right":"center",vertical:d<0?"top":0<l?"bottom":"middle"};n<h&&s(i+r)<n&&(p.horizontal="center"),c<f&&s(l+d)<c&&(p.vertical="middle"),o(s(i),s(r))>o(s(l),s(d))?p.important="horizontal":p.important="vertical",e.using.call(this,t,p)}),a.offset(t.extend(E,{using:l}))}))},t.ui.position={fit:{left:function(t,e){var i,n=e.within,s=n.isWindow?n.scrollLeft:n.offset.left,r=n.width,l=t.left-e.collisionPosition.marginLeft,a=s-l,h=l+e.collisionWidth-r-s;e.collisionWidth>r?0<a&&h<=0?(i=t.left+a+e.collisionWidth-r-s,t.left+=a-i):t.left=0<h&&a<=0?s:h<a?s+r-e.collisionWidth:s:0<a?t.left+=a:0<h?t.left-=h:t.left=o(t.left-l,t.left)},top:function(t,e){var i,n=e.within,s=n.isWindow?n.scrollTop:n.offset.top,r=e.within.height,l=t.top-e.collisionPosition.marginTop,a=s-l,h=l+e.collisionHeight-r-s;e.collisionHeight>r?0<a&&h<=0?(i=t.top+a+e.collisionHeight-r-s,t.top+=a-i):t.top=0<h&&a<=0?s:h<a?s+r-e.collisionHeight:s:0<a?t.top+=a:0<h?t.top-=h:t.top=o(t.top-l,t.top)}},flip:{left:function(t,e){var i,n,o=e.within,r=o.offset.left+o.scrollLeft,l=o.width,a=o.isWindow?o.scrollLeft:o.offset.left,h=t.left-e.collisionPosition.marginLeft,c=h-a,f=h+e.collisionWidth-l-a,u="left"===e.my[0]?-e.elemWidth:"right"===e.my[0]?e.elemWidth:0,d="left"===e.at[0]?e.targetWidth:"right"===e.at[0]?-e.targetWidth:0,p=-2*e.offset[0];c<0?((i=t.left+u+d+p+e.collisionWidth-l-r)<0||i<s(c))&&(t.left+=u+d+p):0<f&&(0<(n=t.left-e.collisionPosition.marginLeft+u+d+p-a)||s(n)<f)&&(t.left+=u+d+p)},top:function(t,e){var i,n,o=e.within,r=o.offset.top+o.scrollTop,l=o.height,a=o.isWindow?o.scrollTop:o.offset.top,h=t.top-e.collisionPosition.marginTop,c=h-a,f=h+e.collisionHeight-l-a,u="top"===e.my[1]?-e.elemHeight:"bottom"===e.my[1]?e.elemHeight:0,d="top"===e.at[1]?e.targetHeight:"bottom"===e.at[1]?-e.targetHeight:0,p=-2*e.offset[1];c<0?((n=t.top+u+d+p+e.collisionHeight-l-r)<0||n<s(c))&&(t.top+=u+d+p):0<f&&(0<(i=t.top-e.collisionPosition.marginTop+u+d+p-a)||s(i)<f)&&(t.top+=u+d+p)}},flipfit:{left:function(){t.ui.position.flip.left.apply(this,arguments),t.ui.position.fit.left.apply(this,arguments)},top:function(){t.ui.position.flip.top.apply(this,arguments),t.ui.position.fit.top.apply(this,arguments)}}},t.ui.safeActiveElement=function(t){var e;try{e=t.activeElement}catch(i){e=t.body}return(e=e||t.body).nodeName||(e=t.body),e},t.ui.safeBlur=function(e){e&&"body"!==e.nodeName.toLowerCase()&&t(e).trigger("blur")},
/*!
 ...
 * http://jquery.org/license
 */
t.extend(t.expr[":"],{tabbable:function(e){var i=t.attr(e,"tabindex"),n=null!=i;return(!n||0<=i)&&t.ui.focusable(e,n)}}),
/*!
 ...
 * http://jquery.org/license
 */
t.fn.extend({uniqueId:(u=0,function(){return this.each((function(){this.id||(this.id="ui-id-"+ ++u)}))}),removeUniqueId:function(){return this.each((function(){/^ui-id-\d+$/.test(this.id)&&t(this).removeAttr("id")}))}});
/*!
